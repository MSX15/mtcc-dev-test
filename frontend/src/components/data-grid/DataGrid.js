              ...
              {rows.filter(x => !x.hideOnGrid).map((row, i) => {
                ...
                return (
                  ...
                  `}
                    ...
                    onDoubleClick={(e) => { console.log("ROW OBJECT", row); allowEditRowOnDoubleClick ? onRowDoubleClickEdit(row.original, e) : onRowDoubleClick && onRowDoubleClick(row.original, e) }}
                  >
                    {
                      row.cells.map((cell) => {
                        return (
