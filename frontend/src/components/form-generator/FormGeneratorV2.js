...
import AutoCompleteField from "./FormFieldComponents/AutoCompleteField";
                    ...
                    <div className={"grid grid-cols-12 gap-2"}>
                      {
                        fields.reduce(
                          (accu, field, i) => {
                            ...
                            if (i !== 0) {
                              if (!styling.field.isCellSkipAlternate || (styling.field.isCellSkipAlternate && i % 2 !== 0)) {
                                const cellSkip = field.styling?.cellSkip ?? styling.field.cellSkip;
                            ...
                            if (field.type === "text") {
                              accu.push(<TextField name={field.name} label={field.label} styling={styling.field} {...field.fieldProps} />)
                            }
                            else if (field.type === "dropdown") {
                              accu.push(<DropDownField name={field.name} styling={styling.field} {...field.fieldProps} />)
                            }
                            else if (field.type === "autoComplete") {
                              accu.push(<AutoCompleteField name={field.name} styling={styling.field} {...field.fieldProps} />)
                            }
                            else if (field.type === "dateSelect") {
                              accu.push(<DateSelectField name={field.name} styling={styling.field} {...field.fieldProps} />)
                            }
                            else {
                              accu.push(<TextField name={field.name} label={field.label} styling={styling.field} {...field.fieldProps} />)
                            }
